...
public class ConnectionActivity extends Activity implements View.OnClickListener {
    ...
    private final double[] deltaAbsBuffer = new double[6];
    private boolean deltaAbsStale;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WeakReference<ConnectionActivity> weakActivity =
    ...
    public void receiveMuseDataPacket(final MuseDataPacket p, final Muse muse) {
        ...
        Log.i("ConnectionActivity", "Packet type:"+p.packetType()+"");
        ...
        switch (p.packetType()) {
            ...
            case ACCELEROMETER:
                ...
                break;
            case ALPHA_ABSOLUTE:
                Log.i("ConnectionActivity", "alpha abs received");
            ...
            case THETA_ABSOLUTE:
                ...
                Log.i("ConnectionActivity", "theta abs received");
                getEegChannelValues(thetaAbsBuffer,p);
                thetaAbsStale = true;
                break;
            case THETA_RELATIVE:
                assert(thetaBuffer.length >= n);
                Log.i("ConnectionActivity", "theta rel received");
                getEegChannelValues(thetaBuffer,p);
                thetaStale = true;
                break;
            case BETA_ABSOLUTE:
                assert(betaAbsBuffer.length >= n);
                Log.i("ConnectionActivity", "beta abs received");
                getEegChannelValues(betaAbsBuffer,p);
                betaAbsStale = true;
                break;
            case BETA_RELATIVE:
                assert(betaBuffer.length >= n);
                Log.i("ConnectionActivity", "beta rel received");
                getEegChannelValues(betaBuffer,p);
                betaStale = true;
                break;
            case DELTA_ABSOLUTE:
                assert(deltaAbsBuffer.length >= n);
                Log.i("ConnectionActivity", "delta abs received");
                getEegChannelValues(deltaAbsBuffer,p);
                deltaAbsStale = true;
                break;
            case DELTA_RELATIVE:
                assert(deltaBuffer.length >= n);
                Log.i("ConnectionActivity", "delta rel received");
    ...
    private void updateAlphaAbs() {
        TextView elem1 = (TextView)findViewById(R.id.elem5);
        elem1.setText(String.format("%6.2f", alphaAbsBuffer[0]));
        TextView elem2 = (TextView)findViewById(R.id.elem6);
        elem2.setText(String.format("%6.2f", alphaAbsBuffer[1]));
        TextView elem3 = (TextView)findViewById(R.id.elem7);
        elem3.setText(String.format("%6.2f", alphaAbsBuffer[2]));
        TextView elem4 = (TextView)findViewById(R.id.elem8);
        elem4.setText(String.format("%6.2f", alphaAbsBuffer[3]));
    }

    private void updateTheta() {
        TextView elem1 = (TextView)findViewById(R.id.elem9);
        elem1.setText(String.format("%6.2f", thetaBuffer[0]));
        TextView elem2 = (TextView)findViewById(R.id.elem10);
        elem2.setText(String.format("%6.2f", thetaBuffer[1]));
        TextView elem3 = (TextView)findViewById(R.id.elem11);
        elem3.setText(String.format("%6.2f", thetaBuffer[2]));
        TextView elem4 = (TextView)findViewById(R.id.elem12);
        elem4.setText(String.format("%6.2f", thetaBuffer[3]));
    }

    private void updateAbsTheta() {
        TextView elem1 = (TextView)findViewById(R.id.elem13);
        elem1.setText(String.format("%6.2f", thetaAbsBuffer[0]));
        TextView elem2 = (TextView)findViewById(R.id.elem14);
        elem2.setText(String.format("%6.2f", thetaAbsBuffer[1]));
        TextView elem3 = (TextView)findViewById(R.id.elem15);
        elem3.setText(String.format("%6.2f", thetaAbsBuffer[2]));
        TextView elem4 = (TextView)findViewById(R.id.elem16);
        elem4.setText(String.format("%6.2f", thetaAbsBuffer[3]));
    }
    ...
    class DataListener extends MuseDataListener {
        ...
        DataListener(final WeakReference<ConnectionActivity> activityRef) {
            this.activityRef = activityRef;
        }
